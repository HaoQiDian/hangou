<template>
	<div class="app-goods-tocar">
		<div id="product_detail_spec_html" class="nctouch-bottom-mask up app-goodstocar" v-if="show">
			<div class="nctouch-bottom-mask-bg" @click="toggleCar"></div>
			<div class="nctouch-bottom-mask-block fadeInUp animated">
				<div class="nctouch-bottom-mask-tip" @click="toggleCar"><i></i>点击此处返回</div>
				<div class="nctouch-bottom-mask-top goods-options-info">
					<div class="goods-pic">
						<img :src="goodsimage.goods_image_url">
					</div>
					<dl>
						<dt>{{goodsTitle.goods_name}}</dt>
						<dd class="goods-price">
							￥
							<em>{{goodsTitle.goods_price}}</em>
							<span class="goods-storage">库存：{{goodsTitle.goods_salenum}}件</span>
						</dd>
					</dl>
					<a class="nctouch-bottom-mask-close"><i @click="toggleCar"></i></a>
				</div>
				...
				<div class="goods-option-value">购买数量
					<div class="value-box">
						<span class="minus" @click="decrease">
                    <a >&nbsp;</a>
                </span>
						<span>
                    <input type="text"  class="buy-num" id="buynum" :value="count">
                </span>
						<span class="add" @click="increment">
                    <a>&nbsp;</a>
                </span>
					</div>
				</div>
				<div class="goods-option-foot">
					<div class="otreh-handle">
						...
						<router-link class="cart" to="/shopcar">
							<i></i>
							<p>购物车</p>
						</router-link>
					</div>
					<div class="buy-handle ">
						<a class="add-cart" id="add-cart" @click="addGood({id:goodsID,price:goodsTitle.goods_price,title:goodsTitle.goods_name,image:goodsimage.goods_image_url})">加入购物车</a>
...
<script>
	...
	export default {
		name: 'app-goods-tocar',
		props: ["toggleCar", 'goodsTitle', "goodsimage", "goodsID"],
		data: function() {
			return {
				show: true,
			}
